...
import { Card, Image, Tooltip, Skeleton, Modal, Badge } from "antd";
import { FileSearchOutlined, ShoppingCartOutlined, BranchesOutlined } from "@ant-design/icons";
                ...
                <Badge count={10} overflowCount={999} color={"blue"} key={index}>
                  <Card
                    ...
                    actions={[
                      ...
                      <Tooltip title="Fork Lore">
                        <BranchesOutlined onClick={() => handleForkClick(nft)} />
                      </Tooltip>,
